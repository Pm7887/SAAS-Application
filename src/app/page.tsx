...
export default function Home() {
  return (
    <main>
      ...
      !overflow-visible relative flex flex-col items-center
      antialiased">
      ...
      <div className="flex flex-col mt-[-100px] md:mt-[-50px]">
        <ContainerScroll
            ...
            <div className="flex items-center justify-center flex-col">
              <Button 
                ...
                border-t-2 rounded-full border-[#4D4D4D] bg-
                [#1F1F1F]hover:bg-white group transition-all flex
              ...
              >
                ...
                md:text-center font-sans group-hover:bg-gradient-to-r
                group-hover:from-black goup-hover:to-black">
                  Start For Free Today
                </span>
              </Button>
             <h1 className="text-5x1 md: text-8xl bg-clip-text
       ...
       />
        ...
        <InfiniteMovingCards
        className="md:mt-[29rem] mt-[200px]"
        items={clients}
        direction="right"
        speed="slow"
        />
    ...
    <LampComponent />
    <div className="flex flex-wrap items-center justify-center flex-colmd: flex-row gap-8 -mt-72">
